...
# spotify-lyrics.py (https://github.com/cjlh/spotify-lyrics)
# Author: Caleb Hamilton
# Website: http://calebh.com
...
def get_song_info():
    ...
    spotify_metadata = dbus.Interface(spotify_bus, "org.freedesktop.DBus.Properties").Get("org.mpris.MediaPlayer2.Player", "Metadata")
    return [str(spotify_metadata['xesam:artist'][0].title()), str(spotify_metadata['xesam:title'])]
